...
const canDeleteRole = (row) => {
  // 调试信息
  console.log('canDeleteRole check:', {
    row: row,
    user: authStore.user,
    userRoles: authStore.userRoles,
    hasSystemAdmin: authStore.hasRole('system_admin')
...
const canAssignPermissions = (row) => {
  // 调试信息
  console.log('canAssignPermissions check:', {
    row: row,
    user: authStore.user,
    userRoles: authStore.userRoles,
    hasSystemAdmin: authStore.hasRole('system_admin')
