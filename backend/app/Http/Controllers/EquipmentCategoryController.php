...
class EquipmentCategoryController extends Controller
{
    ...
    {
        try {
            $query = EquipmentCategory::with(['parent', 'organization', 'creator']);
            ...
            return response()->json([
                'success' => false,
                'message' => '获取设备分类列表失败：' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function tree(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => '获取设备分类树失败：' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function store(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'code' => 'required|string|max:50|unique:equipment_categories',
    ...
    {
        try {
            $category = EquipmentCategory::with(['parent', 'children', 'organization', 'creator', 'updater'])
                ->findOrFail($id);
            ...
            return response()->json([
                'success' => false,
                'message' => '获取设备分类详情失败：' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function update(Request $request, $id): JsonResponse
    {
        $request->validate([
            'name' => 'required|string|max:100',
            'code' => 'required|string|max:50|unique:equipment_categories,code,' . $id,
            'description' => 'nullable|string',
            'parent_id' => 'nullable|exists:equipment_categories,id',
            'subject' => 'nullable|string|max:50',
            'grade_range' => 'nullable|string|max:100',
