...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('material_categories', function (Blueprint $table) {
            ...
            $table->enum('material_type', ['consumable', 'reusable', 'chemical', 'biological'])->comment('材料类型');
            ...
            // 外键约束
            $table->foreign('parent_id')->references('id')->on('material_categories')->onDelete('cascade');
